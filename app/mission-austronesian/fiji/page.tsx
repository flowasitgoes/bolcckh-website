...
export const metadata: Metadata = {
  title: '斐濟共和國專區 | 高雄靈糧堂 - 南島趴趴走',
  description: '高雄靈糧堂斐濟共和國專區，探索斐濟的宣教工作與文化。',
  keywords: '高雄靈糧堂, 斐濟共和國, 南島趴趴走, 宣教使命, 文化探索',
}
            ...
            <div className="w-full">
              ...
              <div className="bg-white shadow-sm p-12">
                ...
                <div className="text-center mb-12">
                  <h1 className="text-4xl font-bold text-[#333] mb-4">斐濟共和國專區</h1>
                  <p className="text-lg text-gray-600">探索斐濟的宣教工作與文化</p>
                </div>
