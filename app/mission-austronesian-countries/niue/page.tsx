...
export const metadata: Metadata = {
  title: '紐埃專區 | 高雄靈糧堂 - 南島語系國家',
  description: '高雄靈糧堂紐埃專區，探索紐埃的宣教工作與文化。',
  keywords: '高雄靈糧堂, 紐埃, 南島語系國家, 宣教使命, 文化探索',
}
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="w-full">
              ...
              <nav className="mission-breadcrumb text-sm text-gray-600 p-12">
                ...
                <span className="mx-2">{'>'}</span>
                <span className="text-[#21807a]">紐埃專區</span>
              </nav>
              ...
              <div className="bg-white shadow-sm p-12">
                ...
                <div className="text-center mb-12 md:bg-[#fe7f4d] md:py-10 md:pb-6">
                  <h1 className="text-4xl font-bold text-[#333] mb-4">紐埃</h1>
                  <h2 className="text-2xl text-gray-600 mb-4 md:text-[#434343]">Niue</h2>
                </div>
