...
export const metadata: Metadata = {
  title: '密克羅尼西亞聯邦專區 | 高雄靈糧堂 - 南島語系國家',
  description: '高雄靈糧堂密克羅尼西亞聯邦專區，探索密克羅尼西亞的宣教工作與文化。',
  keywords: '高雄靈糧堂, 密克羅尼西亞聯邦, 南島語系國家, 宣教使命, 文化探索',
}
            ...
            <div className="w-full">
              ...
              <div className="bg-white shadow-sm p-12">
                ...
                <div className="text-center mb-12 md:bg-[#fe7f4d] md:py-10 md:pb-6">
                  <h1 className="text-4xl font-bold text-[#333] mb-4">密克羅尼西亞聯邦</h1>
                  <h2 className="text-2xl text-gray-600 mb-4 md:text-[#434343]">Federated States of Micronesia</h2>
                </div>
