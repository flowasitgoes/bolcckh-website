                  ...
                  <div className="text-center">
                    <div className="mb-4">
                      <iframe 
                        width="560" 
                        height="315" 
                        src="https://www.youtube.com/embed/hxU1YsJRulE?si=LzpdppBF_4nj9zPx" 
                    ...
                    <h3 className="text-xl font-bold text-[#21807a]">經歷上帝 生命歸主</h3>
                  </div>
                  ...
                  <div className="text-center">
                    <div className="mb-4">
                      <iframe 
                        width="560" 
                        height="315" 
                        src="https://www.youtube.com/embed/iF8GXLS_7nU?si=hiAHn_Ph60-jwPGd" 
                        title="YouTube video player" 
                        frameBorder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        referrerPolicy="strict-origin-when-cross-origin" 
                  ...
                  <div className="text-center">
                    <div className="mb-4">
                      <iframe 
                        width="560" 
                        height="315" 
                        src="https://www.youtube.com/embed/KSxguBzeUJs?si=NJVpwKJEeTLPLgMZ" 
                        title="YouTube video player" 
                        frameBorder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        referrerPolicy="strict-origin-when-cross-origin" 
