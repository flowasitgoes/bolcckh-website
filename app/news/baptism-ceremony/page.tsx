...
export const metadata: Metadata = {
  title: '受洗典禮 | 高雄靈糧堂 - 教會消息',
  description: '高雄靈糧堂受洗典禮活動詳情，6/22-6/28期間舉行，見證弟兄姊妹在基督裡的新生命。',
  keywords: '高雄靈糧堂, 受洗典禮, 洗禮, 教會活動',
}

export default function BaptismCeremonyPage() {
  return (
            ...
            <div className="news-layout">
              ...
              <div className="news-content">
                ...
                <nav className="news-breadcrumb text-sm text-gray-600 p-12">
                  ...
                  <span className="mx-2">{'>'}</span>
                  <span className="text-[#21807a]">受洗典禮</span>
                </nav>
                ...
                <div className="bg-white shadow-sm">
                  <div className="news-content-wrapper p-12">
                    ...
                    <div className="mb-8">
                      ...
                      <p className="text-gray-600">6/22 (日) - 6/28 (日)</p>
                    </div>

                    {/* Article Image */}
                    <div className="mb-8">
                      <img
                        src="/home/news-section/03.jpg"
                        alt="受洗典禮"
