            ...
            <div className="bg-white rounded-lg p-6 md:p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <label className="flex items-center space-x-1">
                      <input 
                        className="w-4 h-4" 
                        type="checkbox"
                        checked={formData.groomIsMember}
                        onChange={(e) => handleInputChange('groomIsMember', e.target.checked)}
                      />
                      <span>是</span>
                    </label>
                    <label className="flex items-center space-x-1">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <label className="flex items-center space-x-1">
                      <input 
                        className="w-4 h-4" 
                        type="checkbox"
                        checked={formData.brideIsMember}
                        onChange={(e) => handleInputChange('brideIsMember', e.target.checked)}
                      />
                      <span>是</span>
                    </label>
                    <label className="flex items-center space-x-1">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2 text-sm">
                    ...
                    <input 
                      ...
                      placeholder="年" 
                      type="number"
                      value={formData.rehearsalYear}
                      onChange={(e) => handleInputChange('rehearsalYear', e.target.value)}
                    />
                    <span>年</span>
                    <input 
                      className="border-b border-gray-400 w-12 text-center" 
                      placeholder="月" 
                      type="number"
                      value={formData.rehearsalMonth}
                      onChange={(e) => handleInputChange('rehearsalMonth', e.target.value)}
                    />
                    <span>月</span>
                    <input 
                      className="border-b border-gray-400 w-12 text-center" 
                      ...
                      onChange={(e) => handleInputChange('rehearsalDay', e.target.value)}
                    />
                    <span>日</span>
                    <span>星期(</span>
                    <input 
                      ...
                      placeholder="" 
                      type="text"
                      value={formData.rehearsalWeek}
                      onChange={(e) => handleInputChange('rehearsalWeek', e.target.value)}
                    />
                    <span>)</span>
                    <label className="flex items-center space-x-1">
                      <input 
                        ...
                        value="am" 
                        name="rehearsal_time"
                        checked={formData.rehearsalTime === 'am'}
                        onChange={(e) => handleInputChange('rehearsalTime', e.target.value)}
                      />
                      <span>am</span>
                    </label>
                    <label className="flex items-center space-x-1">
                      <input 
                        ...
                        value="pm" 
                        name="rehearsal_time"
                        checked={formData.rehearsalTime === 'pm'}
                        onChange={(e) => handleInputChange('rehearsalTime', e.target.value)}
                      />
                      <span>pm</span>
                    </label>
                    <input 
                      ...
                      onChange={(e) => handleInputChange('rehearsalStartTime', e.target.value)}
                    />
                    <span>至</span>
                    <input 
                      className="border-b border-gray-400 px-2" 
                      ...
                      onChange={(e) => handleInputChange('rehearsalEndTime', e.target.value)}
                    />
                    <span>止</span>
                  </div>
                </div>
                ...
                <div className="border-2 border-gray-800 p-4 space-y-3">
                  ...
                  <div className="text-sm">請選場地告示(1F、B1、B2)</div>
                </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <label className="flex items-center space-x-2">
                      <input 
                        className="w-4 h-4" 
                        type="checkbox"
                        checked={formData.equipment.carpet}
                        onChange={(e) => handleEquipmentChange('carpet', e.target.checked)}
                      />
                      <span>紅地毯</span>
                    </label>
                    <label className="flex items-center space-x-2">
                    ...
                    <label className="flex items-center space-x-2">
                      <input 
                        className="w-4 h-4" 
                        type="checkbox"
                        checked={formData.equipment.folders}
                        onChange={(e) => handleEquipmentChange('folders', e.target.checked)}
                      />
                      <span>譜夾30本</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input 
                        ...
                        onChange={(e) => handleEquipmentChange('chairs', e.target.checked)}
                      />
                      <span>拍照用塑膠椅10張</span>
                    </label>
                  </div>
