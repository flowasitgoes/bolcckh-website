                          ...
                          <tr key={index}>
                            ...
                            <td className="border border-gray-300 px-3 py-2 text-center">
                              <input
                                ...
                                onChange={() => handleMemberChange(index, 'sunday', !member.sunday)}
                            ...
                            <td className="border border-gray-300 px-3 py-2 text-center">
                              <input
                                ...
                                onChange={() => handleMemberChange(index, 'group', !member.group)}
                                className="w-4 h-4 text-[#21807a]"
                              />
                            </td>
                            <td className="border border-gray-300 px-3 py-2 text-center">
                              <input
                                ...
                                onChange={() => handleMemberChange(index, 'equipping', !member.equipping)}
                                className="w-4 h-4 text-[#21807a]"
                              />
                            </td>
                            <td className="border border-gray-300 px-3 py-2 text-center">
                              <input
                                ...
                                onChange={() => handleMemberChange(index, 'disciple', !member.disciple)}
                                className="w-4 h-4 text-[#21807a]"
                              />
                            </td>
                            <td className="border border-gray-300 px-3 py-2 text-center">
                              <input
                                ...
                                onChange={() => handleMemberChange(index, 'tithe', !member.tithe)}
                                className="w-4 h-4 text-[#21807a]"
                              />
                            </td>
                            <td className="border border-gray-300 px-3 py-2">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <label className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        checked={formData.meetingContent.worship}
                        onChange={(e) => handleMeetingContentChange('worship', e.target.checked)}
                        className="w-4 h-4 text-[#21807a] rounded focus:ring-[#21807a]"
                      />
                      <span className="text-sm text-gray-700">禮拜</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        checked={formData.meetingContent.prayer}
                        onChange={(e) => handleMeetingContentChange('prayer', e.target.checked)}
                        className="w-4 h-4 text-[#21807a] rounded focus:ring-[#21807a]"
                      />
                      <span className="text-sm text-gray-700">禱告</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        checked={formData.meetingContent.word}
                        onChange={(e) => handleMeetingContentChange('word', e.target.checked)}
                        className="w-4 h-4 text-[#21807a] rounded focus:ring-[#21807a]"
                      />
                      <span className="text-sm text-gray-700">神的話</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        checked={formData.meetingContent.care}
                        onChange={(e) => handleMeetingContentChange('care', e.target.checked)}
                        className="w-4 h-4 text-[#21807a] rounded focus:ring-[#21807a]"
                      />
                      <span className="text-sm text-gray-700">關心組員</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        checked={formData.meetingContent.service}
                        onChange={(e) => handleMeetingContentChange('service', e.target.checked)}
                        className="w-4 h-4 text-[#21807a] rounded focus:ring-[#21807a]"
                      />
                      <span className="text-sm text-gray-700">服事</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        checked={formData.meetingContent.evangelism}
                        onChange={(e) => handleMeetingContentChange('evangelism', e.target.checked)}
                        className="w-4 h-4 text-[#21807a] rounded focus:ring-[#21807a]"
                      />
                      <span className="text-sm text-gray-700">傳福音</span>
                    </label>
                  </div>
                </div>
