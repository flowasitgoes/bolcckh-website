...
export const metadata: Metadata = {
  title: '門徒學校上-週二班完成報名查詢 | 高雄靈糧堂',
  description: '高雄靈糧堂門徒學校上冊週二班完成報名查詢，查看報名狀態。',
  keywords: '高雄靈糧堂, 門徒學校, 週二班, 報名查詢, 門徒訓練',
}

export default function DiscipleshipSchoolUpperTuesdayPage() {
  return (
