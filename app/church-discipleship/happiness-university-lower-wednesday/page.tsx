...
export const metadata: Metadata = {
  title: '幸福大學下-週三班完成報名查詢 | 高雄靈糧堂',
  description: '高雄靈糧堂幸福大學下冊週三班完成報名查詢，查看報名狀態。',
  keywords: '高雄靈糧堂, 幸福大學, 週三班, 報名查詢, 幸福課程',
}

export default function HappinessUniversityLowerWednesdayPage() {
  return (
                ...
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <iframe 
                        src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRlnp-RdOdg2TsG7uiNteBOsfxENKbL9c8NBex8_8qcqERecd8chIf9GS1uL-Ya1GYCpIs2oNK2QPCk/pubhtml?gid=2076974207&single=true&widget=true&headers=false" 
                        width="100%" 
                        height="500"
