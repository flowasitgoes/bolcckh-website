...
export const metadata: Metadata = {
  title: '幸福大學上-週四班完成報名查詢 | 高雄靈糧堂',
  description: '高雄靈糧堂幸福大學上冊週四班完成報名查詢，查看報名狀態。',
  keywords: '高雄靈糧堂, 幸福大學, 週四班, 報名查詢, 幸福課程',
}

export default function HappinessUniversityUpperThursdayPage() {
  return (
